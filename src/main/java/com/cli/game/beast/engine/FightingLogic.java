 ...
 * 
 */
package com.cli.game.beast.engine;
...
public class FightingLogic {
	...
	private static FightingLogic INSTANCE;

	public static FightingLogic getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new FightingLogic();
		}
		return INSTANCE;
	}

	private FightingLogic() {
		fScreen = new JFrame("One Piece vs Naruto Fight");
	...
	private void mPlayersMove(int runEnemy) {
	...
	private void mCompAllMovements() {
